...
public class StudentNotesSubjectAdapter extends RecyclerView.Adapter<StudentNotesSubjectAdapter.ViewHolder> {
    ...
    StudentNotesSubject context;

    public StudentNotesSubjectAdapter(List<SubjectName> subjectNameList, StudentNotesSubject context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StudentNotesList fragment = StudentNotesList.newInstance(subjectName.getNameOfSubject());
